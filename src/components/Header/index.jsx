        ...
        <div className="container">
          <div className={styles.headerTopInner}>
            <div className={styles.headerTopLeft}>
              <a
                className={styles.headerLinkMail}
                href="mailto:callmegrisha@gmail.com"
              >
                callmegrisha@gmail.com
              </a>
              <a className={styles.headerLinkNumber} href="tel:380669262269">
                (066) 926-22-69
              </a>
            </div>
            <div className={styles.headerTopRight}>
              <Link className={styles.headerLinkWishlist} to="/wishlist">
                Wishlist
              </Link>
          ...
          <div className={styles.headerNavInner}>
            ...
            <ul className={styles.headerMenu}>
              <li className={styles.headerMenuItem}>
                <Link className={styles.headerMenuLink} to="/orders">
                  Orders
                </Link>
              </li>
              <li className={styles.headerMenuItem}>
